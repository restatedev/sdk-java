...
/**
 * A {@link ConcurrentHashMap} variant that uses {@link ReferenceType#SOFT soft} or {@linkplain
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V>
   ...
   */
  protected final @Nullable Reference<K, V> getReference(
      @Nullable Object key, Restructure restructure) {
  ...
  private @Nullable V put(
      final @Nullable K key, final @Nullable V value, final boolean overwriteExisting) {
    return doTask(
        key,
  ...
  public @Nullable V computeIfAbsent(
      @Nullable K key, Function<@Nullable ? super K, @Nullable ? extends V> mappingFunction) {
    return doTask(
        key,
        new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE) {
          @Override
  ...
  public @Nullable V computeIfPresent(
      @Nullable K key,
      BiFunction<@Nullable ? super K, @Nullable ? super V, @Nullable ? extends V>
          remappingFunction) {
    return doTask(
        key,
        new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE) {
  ...
  public @Nullable V merge(
      @Nullable K key,
      @Nullable V value,
      BiFunction<@Nullable ? super V, @Nullable ? super V, @Nullable ? extends V>
          remappingFunction) {
    return doTask(
        key,
        new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE) {
  ...
  protected final class Segment extends ReentrantLock {
    ...
    public @Nullable Reference<K, V> getReference(
          ...
          for (int i = 0; i < this.references.length; i++) {
            ...
            while (ref != null) {
              if (!toPurge.contains(ref)) {
                ...
                if (entry != null) {
                  purgedRef =
                      this.referenceManager.createReference(entry, ref.getHash(), purgedRef);
                }
                newCount++;
              }
              ref = ref.getNext();
    ...
    private @Nullable Reference<K, V> findInChain(
        @Nullable Reference<K, V> ref, @Nullable Object key, int hash) {
   ...
   * around specific Java reference implementations (for example, {@link SoftReference}).
   *
   * @param <K> the key type
   * @param <V> the value type
   */
  ...
  protected static final class Entry<K, V> implements Map.Entry<K, V> {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof Map.Entry<?, ?> that
