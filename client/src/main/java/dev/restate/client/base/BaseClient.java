...
public abstract class BaseClient implements Client {
  ...
  protected BaseClient(URI baseUri, @Nullable SerdeFactory serdeFactory, @Nullable ClientRequestOptions baseOptions) {
    ...
    this.serdeFactory = serdeFactory == null ? DefaultSerdeFactorySingleton.INSTANCE.getLoadedFactory() : serdeFactory;
  ...
  public static final class DefaultSerdeFactory {
    ...
    public DefaultSerdeFactory() {
      ...
      if (loadedFactories.size() == 1) {
        ...
        this.loadedFactory = new SerdeFactory() {
          @Override
      ...
      if (loadedFactories.size() > 1) {
        LOG.warn("When creating the Client, more than one SerdeFactory was found.\n" +
