...
public final class HandlerSpecification<REQ, RES> {
    ...
    HandlerSpecification(String name, HandlerType handlerType, @Nullable String acceptContentType, Serde<REQ> requestSerde, Serde<RES> responseSerde) {
        this.name = name;
    ...
    public HandlerSpecification<REQ, RES> withAcceptContentType(String acceptContentType) {
        return new HandlerSpecification<>(name, handlerType, acceptContentType, requestSerde, responseSerde);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, that.name) && handlerType == that.handlerType && Objects.equals(acceptContentType, that.acceptContentType) && Objects.equals(requestSerde, that.requestSerde) && Objects.equals(responseSerde, that.responseSerde);
    }
    ...
    public String toString() {
        return "HandlerSpecification{" +
                ...
                ", requestContentType=" + requestSerde.contentType() +
                ", responseContentType=" + responseSerde.contentType() +
                '}';
    }
}
