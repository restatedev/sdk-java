...
public enum MessageType {
  ...
  // SDK specific messages
  CompletionOrderEntryMessage;
  ...
  public Parser<? extends MessageLite> messageParser() {
    switch (this) {
      ...
      case CompletionOrderEntryMessage:
        return Java.CompletionOrderEntryMessage.parser();
    }
  ...
  public static MessageType decode(short value) throws ProtocolException {
    switch (value) {
      ...
      case (short) 0xFC00:
        return CompletionOrderEntryMessage;
    }
