    ...
    Stream<TestDefinition> definitions() {
        return Stream.of(
                endToEndTestInvocation()
                        ...
                        .withInput(testInput().withMethod(GreeterOneGrpc.getGreetMethod())
                ...
                endToEndTestInvocation()
                        .withServices(new GreeterOne())
                        .withInput(testInput().withMethod(GreeterOneGrpc.getStoreAndGreetMethod())
                                        .withMessage(greeterOneRequest("Goofy")))
                        .usingThreadingModels(ThreadingModel.BUFFERED_SINGLE_THREAD)
                        .expectingOutput(greeterOneResponse("Hello Goofy"))
                ...
                endToEndTestInvocation()
                        ...
                        .usingThreadingModels(ThreadingModel.BUFFERED_SINGLE_THREAD)
                        .expectingOutput(
                                greeterOneResponse("Greeting has been forwarded to GreeterTwo! Not waiting for a response."),
                                outputMessage(GreeterTwoResponse.newBuilder().setMessage("Hello Goofy #2")),
                                greeterOneResponse("Greeting has been forwarded to GreeterTwo. Response was: Hello Goofy #3"))
                ...
                endToEndTestInvocation()
                        ...
                        .withInput(
                                testInput().withMethod(GreeterOneGrpc.getGetMultipleGreetingsMethod())
                                        .withMessage(greeterOneRequest("Goofy")))
                        .usingThreadingModels(ThreadingModel.BUFFERED_SINGLE_THREAD)
                        .expectingOutput(greeterOneResponse(
