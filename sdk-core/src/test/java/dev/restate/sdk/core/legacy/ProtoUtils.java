...
public class ProtoUtils {
  ...
  public static Protocol.RunCompletionNotificationMessage.Builder runCompletion(
      int completionId, int code, String message, Map<String, String> metadata) {
    return Protocol.RunCompletionNotificationMessage.newBuilder()
        .setCompletionId(completionId)
        .setFailure(failure(code, message, metadata));
  }
  ...
  public static Protocol.Failure failure(int code, String message, Map<String, String> metadata) {
    return Util.toProtocolFailure(code, message, metadata);
  }
