...
public enum MessageType {
  ...
  public short encode() {
    return switch (this) {
      ...
      case GetLazyStateCompletionNotificationMessage ->
          GetLazyStateCompletionNotificationMessage_TYPE;
      ...
      case GetLazyStateKeysCompletionNotificationMessage ->
          GetLazyStateKeysCompletionNotificationMessage_TYPE;
      ...
      case PeekPromiseCompletionNotificationMessage ->
          PeekPromiseCompletionNotificationMessage_TYPE;
      case CompletePromiseCommandMessage -> CompletePromiseCommandMessage_TYPE;
      case CompletePromiseCompletionNotificationMessage ->
      ...
      case CallInvocationIdCompletionNotificationMessage ->
      ...
      case AttachInvocationCompletionNotificationMessage ->
          AttachInvocationCompletionNotificationMessage_TYPE;
      case GetInvocationOutputCommandMessage -> GetInvocationOutputCommandMessage_TYPE;
      case GetInvocationOutputCompletionNotificationMessage ->
          GetInvocationOutputCompletionNotificationMessage_TYPE;
  ...
  public static MessageType decode(short value) throws ProtocolException {
    return switch (value) {
      ...
      case GetLazyStateKeysCompletionNotificationMessage_TYPE ->
          GetLazyStateKeysCompletionNotificationMessage;
      ...
      case PeekPromiseCompletionNotificationMessage_TYPE ->
          PeekPromiseCompletionNotificationMessage;
      case CompletePromiseCommandMessage_TYPE -> CompletePromiseCommandMessage;
      case CompletePromiseCompletionNotificationMessage_TYPE ->
          CompletePromiseCompletionNotificationMessage;
      ...
      case CallInvocationIdCompletionNotificationMessage_TYPE ->
          CallInvocationIdCompletionNotificationMessage;
      ...
      case AttachInvocationCompletionNotificationMessage_TYPE ->
          AttachInvocationCompletionNotificationMessage;
      case GetInvocationOutputCommandMessage_TYPE -> GetInvocationOutputCommandMessage;
      case GetInvocationOutputCompletionNotificationMessage_TYPE ->
          GetInvocationOutputCompletionNotificationMessage;
  ...
  public static MessageType fromMessage(MessageLite msg) {
    if (msg instanceof Protocol.StartMessage) {
      return MessageType.StartMessage;
    ...
    } else if (msg instanceof Protocol.GetLazyStateCommandMessage) {
      return MessageType.GetLazyStateCommandMessage;
    } else if (msg instanceof Protocol.GetLazyStateCompletionNotificationMessage) {
      return MessageType.GetLazyStateCompletionNotificationMessage;
    } else if (msg instanceof Protocol.SetStateCommandMessage) {
      return MessageType.SetStateCommandMessage;
    } else if (msg instanceof Protocol.ClearStateCommandMessage) {
      return MessageType.ClearStateCommandMessage;
    } else if (msg instanceof Protocol.ClearAllStateCommandMessage) {
      return MessageType.ClearAllStateCommandMessage;
    } else if (msg instanceof Protocol.GetLazyStateKeysCommandMessage) {
      return MessageType.GetLazyStateKeysCommandMessage;
    } else if (msg instanceof Protocol.GetLazyStateKeysCompletionNotificationMessage) {
      return MessageType.GetLazyStateKeysCompletionNotificationMessage;
    } else if (msg instanceof Protocol.GetEagerStateCommandMessage) {
      return MessageType.GetEagerStateCommandMessage;
    } else if (msg instanceof Protocol.GetEagerStateKeysCommandMessage) {
      return MessageType.GetEagerStateKeysCommandMessage;
    } else if (msg instanceof Protocol.GetPromiseCommandMessage) {
      return MessageType.GetPromiseCommandMessage;
    } else if (msg instanceof Protocol.GetPromiseCompletionNotificationMessage) {
      return MessageType.GetPromiseCompletionNotificationMessage;
    } else if (msg instanceof Protocol.PeekPromiseCommandMessage) {
      return MessageType.PeekPromiseCommandMessage;
    } else if (msg instanceof Protocol.PeekPromiseCompletionNotificationMessage) {
      return MessageType.PeekPromiseCompletionNotificationMessage;
    } else if (msg instanceof Protocol.CompletePromiseCommandMessage) {
      return MessageType.CompletePromiseCommandMessage;
    } else if (msg instanceof Protocol.CompletePromiseCompletionNotificationMessage) {
      return MessageType.CompletePromiseCompletionNotificationMessage;
    } else if (msg instanceof Protocol.SleepCommandMessage) {
      return MessageType.SleepCommandMessage;
    } else if (msg instanceof Protocol.SleepCompletionNotificationMessage) {
      return MessageType.SleepCompletionNotificationMessage;
    } else if (msg instanceof Protocol.CallCommandMessage) {
      return MessageType.CallCommandMessage;
    } else if (msg instanceof Protocol.CallInvocationIdCompletionNotificationMessage) {
      return MessageType.CallInvocationIdCompletionNotificationMessage;
    } else if (msg instanceof Protocol.CallCompletionNotificationMessage) {
      return MessageType.CallCompletionNotificationMessage;
    } else if (msg instanceof Protocol.OneWayCallCommandMessage) {
      return MessageType.OneWayCallCommandMessage;
    } else if (msg instanceof Protocol.SendSignalCommandMessage) {
      return MessageType.SendSignalCommandMessage;
    } else if (msg instanceof Protocol.RunCommandMessage) {
      return MessageType.RunCommandMessage;
    } else if (msg instanceof Protocol.RunCompletionNotificationMessage) {
      return MessageType.RunCompletionNotificationMessage;
    } else if (msg instanceof Protocol.AttachInvocationCommandMessage) {
      return MessageType.AttachInvocationCommandMessage;
    } else if (msg instanceof Protocol.AttachInvocationCompletionNotificationMessage) {
      return MessageType.AttachInvocationCompletionNotificationMessage;
    } else if (msg instanceof Protocol.GetInvocationOutputCommandMessage) {
      return MessageType.GetInvocationOutputCommandMessage;
    } else if (msg instanceof Protocol.GetInvocationOutputCompletionNotificationMessage) {
      return MessageType.GetInvocationOutputCompletionNotificationMessage;
    } else if (msg instanceof Protocol.CompleteAwakeableCommandMessage) {
      return MessageType.CompleteAwakeableCommandMessage;
    } else if (msg instanceof Protocol.SignalNotificationMessage) {
      return MessageType.SignalNotificationMessage;
    }
