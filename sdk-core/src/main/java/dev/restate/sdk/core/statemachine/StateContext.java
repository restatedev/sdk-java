...
final class StateContext {
    ...
    public void writeMessageOut(MessageLite msg) {
        Objects.requireNonNull(this.outputSubscriber, "Output subscriber should be configured before running the state machine").onNext(msg);
    }

    public void maybeWriteMessageOut(MessageLite msg) {
