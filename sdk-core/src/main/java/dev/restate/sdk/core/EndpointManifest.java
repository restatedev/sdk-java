  ...
  private static Input convertHandlerInput(HandlerDefinition<?, ?> def) {
    ...
    if (jsonSchema instanceof Serde.JsonSchema schema) {
      ...
      try {
        ...
        throw new RuntimeException("The schema generated by " + def.getRequestSerde() + " is not a valid JSON", e);
      }
    }
    return input;
  }
  ...
  private static Output convertHandlerOutput(HandlerDefinition<?, ?> def) {
    ...
    if (jsonSchema instanceof Serde.JsonSchema schema) {
      ...
      try {
        ...
        throw new RuntimeException("The schema generated by " + def.getResponseSerde() + " is not a valid JSON", e);
      }
    }
    return output;
  }
