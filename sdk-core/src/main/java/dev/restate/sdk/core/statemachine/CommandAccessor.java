...
interface CommandAccessor<E extends MessageLite> {
  ...
  CommandAccessor<Protocol.CallCommandMessage> CALL = Protocol.CallCommandMessage::getName;
      ...
      new CommandAccessor<>() {
        ...
        public void checkEntryHeader(Protocol.OneWayCallCommandMessage expected, MessageLite actual)
          ...
          if (!(Objects.equals(expected.getServiceName(), actualOneWayCall.getServiceName())
              ...
              && Objects.equals(
                  expected.getInvocationIdNotificationIdx(),
                  actualOneWayCall.getInvocationIdNotificationIdx()))) {
            throw ProtocolException.commandDoesNotMatch(expected, actual);
          }
        }
      };
  ...
  CommandAccessor<Protocol.RunCommandMessage> RUN = Protocol.RunCommandMessage::getName;
